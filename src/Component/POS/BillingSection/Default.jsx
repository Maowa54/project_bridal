...
const Default = ({totalPrice , singleQuantity, variationQuantity, removeAllProducts, businessId , productStock,  productVariations  , handleErrors}) => {
        ...
        <div className="">
          ...
          <div className=' flex-1'>
            ...
            shadow-[rgba(0,_0,_0,_0.20)_0px_2px_6px] h-8
              text-[14px] md:text-[16px] font-semibold rounded-lg w-full p-1"  value={phoneNumber}  onChange={(e) => setPhoneNumber(e.target.value)}
              />
