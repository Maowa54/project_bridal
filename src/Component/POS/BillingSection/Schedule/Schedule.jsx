...
const Schedule = ({ totalPrice, singleQuantity, variationQuantity, removeAllProducts, businessId, productStock, productVariations, handleErrors }) => {
...
text-[14px] md:text-[16px] font-semibold rounded-lg w-full p-1" 
 value={phoneNumber}  onChange={(e) => setPhoneNumber(e.target.value)}
      ...
      <div className='flex gap-2 flex-wrap'>
        ...
        <div className=" flex-1">
          ...
          <select
            ...
            className="border h-9 border-gray-300 shadow-[rgba(0,_0,_0,_0.20)_0px_2px_6px] w-full  text-gray-900 text-[14px] md:text-[16px] rounded-lg "
            value={source}
  ...
  className="
    bg-white shadow-[rgba(0,_0,_0,_0.20)_0px_2px_6px] text-[14px] 
...
/>
      ...
      <div className="flex md:flex-col flex-row gap-3">
        ...
        <textarea
          ...
          className=" h-8 md:h-auto border shadow-[rgba(0,_0,_0,_0.20)_0px_2px_6px] rounded w-full px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ></textarea>
  ...
  <Amount totalPrice={totalPrice}/>
      ...
      {advance && advance > 0 && (
        <div className='flex justify-between items-center'>
          ...
          <h1 className='text-gray-400 text-[14px]'>
            <span className='text-[15px] md:text-[12px]'>৳</span> {advanceNum}
          </h1>
        </div>
      )}
      ...
      {totalPriceNum > 0 && (
        <div className='flex justify-between items-center'>
          ...
          <h1 className='text-gray-400 text-[14px]'>
            <span className='text-[15px] md:text-[12px]'>৳</span> {dueAmount}
          </h1>
        </div>
      )}
    ...
    {loading ? (
      ...
      <>
        ...
        <h1 className='text-[18px] font-bold '>
          <span className='text-[18px] font-bold '>৳</span> {dueAmount}
        </h1>
      </>
    )}
  </button>
