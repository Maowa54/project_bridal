...
const variationOptions = variationsData.map((variation) => ({
  ...
  label: variation.name.charAt(0).toUpperCase() + variation.name.slice(1), 
...
const handleVariationChange = (selectedOption, index) => {
  ...
  updatedVariations[index].options = getOptionsForVariation(selectedOption.value);
...
const handleDelete = (index) => {
  ...
  setVariationValuesIds((prevValues) => prevValues.filter((_, i) => i !== index));
};
      ...
      <tr key={`comb-${combIndex}`}>
        ...
        <td className="px-6 py-4 whitespace-nowrap">
          <input
           ...
           required
            type="number"
            value={combination.price || ""}
            onChange={(e) => handleInputChange(e, combIndex, "price")}
            className="form-control rounded-lg shadow border border-gray-300 p-2"
            placeholder="Enter price"
          />
        </td>
        <td className="px-6 py-4 whitespace-nowrap">
          ...
          required
            type="number"
            value={combination.stock || ""}
            onChange={(e) => handleInputChange(e, combIndex, "stock")}
            className="form-control rounded-lg shadow border border-gray-300 p-2"
            placeholder="Enter stock"
          />
        </td>
        <td className="px-6 py-4 whitespace-nowrap">
          ...
          required
            type="number"
            value={combination.discount || ""}
            onChange={(e) => handleInputChange(e, combIndex, "discount")}
            className="form-control rounded-lg shadow border border-gray-300 p-2"
            placeholder="Enter discount"
          />
        </td>
        <td className="px-6 py-4 whitespace-nowrap">
          <input
            type="text"
            value={combination.code || ""}
            onChange={(e) => handleInputChange(e, combIndex, "code")}
            className="form-control rounded-lg shadow border border-gray-300 p-2"
            placeholder="Enter code"
          />
        </td>
