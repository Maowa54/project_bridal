    ...
    <div>
      ...
      <div>
        <div className="grid  font-semibold grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-5 md:ml-0">
          <div className="card  custom-shadow">
            ...
            <div>
              <h1 className=" bg-teal-400 p-3 rounded-b-md text-white">
                {" "}
                <span className=" bg-teal-700  px-5 py-1 rounded-full mr-2">
                  10%{" "}
                </span>{" "}
      ...
      <div className="grid grid-cols-12 gap-4 mt-6">
        ...
        <div className="col-span-12 lg:col-span-4 custom-shadow rounded-lg px-6 py-8">
          ...
          <h3 className="text-sm text-gray-400 font-semibold mb-4">
                ...
                {getStock
                  ...
                  .map((stock) => ({
                    ...
                    minStock:
                      ...
                      stock.variation_combinations.length > 0
                        ? Math.min(
                            ...stock.variation_combinations.map(
                    ...
                    stock.variation_combinations.length > 0 ? (
                      stock.variation_combinations
                        ...
                        .map((variation, varIndex) => (
                          <tr
                            key={`${index}-${varIndex}`}
                            className="border-b hover:bg-gray-100 text-teal-800"
                          >
                            {varIndex === 0 && (
                              <>
                                <td
                                  rowSpan={stock.variation_combinations.length}
                                >
                                  <img
