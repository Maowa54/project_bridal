...
const Sidebar = ({ isOpen, closeSidebar }) => {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 h-full bg-sidebar-gradient-custom text-white py-4 transition-transform z-30 ${
        ...
        <div className="font-semibold md:text-lg mt-6 overflow-y-auto">
          <ul>
                ...
                {item.submenu ? (
                  <>
                    <li
                      ...
                      className="flex cursor-pointer ml-6 items-center py-3"
                    >
                      {item.icon &&
                        ...
                        {item.submenu.map((subItem) => (
                          <li key={subItem.title} className="py-2 list-none ">
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                isActive
                                  ? "bg-teal-700 text-white p-2 w-full rounded flex items-center"
                                  : "p-2 w-full text-gray-100 hover:bg-teal-600 hover:text-white rounded flex items-center"
                              }
            ...
            <div
              ...
              className="cursor-pointer px-5 flex gap-3 hover:bg-teal-700 py-3 items-center"
            >
              <MdLogout size={24} />
